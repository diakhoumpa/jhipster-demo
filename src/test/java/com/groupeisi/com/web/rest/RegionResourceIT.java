...
import com.groupeisi.com.domain.Region;
import com.groupeisi.com.repository.RegionRepository;
...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().regionName(DEFAULT_REGION_NAME).secondName(DEFAULT_SECOND_NAME);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().regionName(UPDATED_REGION_NAME).secondName(UPDATED_SECOND_NAME);
        return region;
    }
    ...
    void createRegion() throws Exception {
        ...
        assertThat(testRegion.getSecondName()).isEqualTo(DEFAULT_SECOND_NAME);
    }
    ...
    void putExistingRegion() throws Exception {
        ...
        updatedRegion.regionName(UPDATED_REGION_NAME).secondName(UPDATED_SECOND_NAME);
        ...
        assertThat(testRegion.getSecondName()).isEqualTo(UPDATED_SECOND_NAME);
    }
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.regionName(UPDATED_REGION_NAME).secondName(UPDATED_SECOND_NAME);
